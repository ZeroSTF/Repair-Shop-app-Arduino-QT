...
staff::staff(QString id ,QString nom ,QString prenom ,QString fonction,QDate date)
{
    this->ID=id ;
    this->nom=nom ;
    this->prenom=prenom;
...
return query.exec();
 ...
 bool staff::modifier(QString id ,QString nom,QString prenom,QString fonction,QDate date_naissance)
 {
     QSqlQuery query ;
 ...
 QSqlQueryModel* staff::triparAge()
  ...
  QSqlQueryModel* staff::rechercher_id(QString id)
  {
  ...
  QSqlQueryModel * staff::rechercher_prenomid(QString prenom, QString idC)
  {
      QSqlQuery *qry= new QSqlQuery();
      //QString id_string=QString::number(idC);
      QSqlQueryModel *model = new QSqlQueryModel();
  ...
  QSqlQueryModel * staff::rechercher_prenom_id_nom(QString prenom, QString idC,QString nom)
  {
      QSqlQuery *qry= new QSqlQuery();
      //QString id_string=QString::number(idC);
      QSqlQueryModel *model = new QSqlQueryModel();
